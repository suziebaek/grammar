...
2. [지문 길이 및 Lexile]: 문제 생성에 필요한 문장 생성 시, 각 문장은 Lexile 800L 수준으로 통제하세요. 할당받은 '문법 개념 표현'을 위해서만 800L 이상의 문장을 허용합니다. 지문을 생성하는 문제의 경우, 최대 6문장까지만 생성하세요.
...
7. [해설 작성 규칙]: 해설에 "이 문제는 ~을 묻고 있다" 같은 출제자의 의도를 설명하는 메타적 코멘트를 절대 금지합니다. 오직 문법적 팩트에 기반하여 건조하게 작성하되, 길이를 엄격하게 제한합니다.
   - [정답 해설]: 핵심 문법 규칙만 설명하며 최대 3문장 이하로 작성하세요.
